                ...
                hint: (
                    <div>
                        <label>
                            ...
                            <b>anonymous</b>
                            &nbsp; usage data to help improve the extension. The
                            events are:
                        </label>
                        <ul>
                            <li class="show-list">
                            ...
                            <li class="show-list">
                                Site ratings shown, such as LEFT, LEFT-CENTER,
                                LEAST, RIGHT-CENTER, RIGHT
                            </li>
                            <li class="show-list">
...
class Options {
    ...
    async waitTilReady(): Promise<void> {
        for (let i = 0; i < 100 && !this.ready; i += 1) {
            await this.delay();
        }
    }
