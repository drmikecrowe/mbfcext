...
export const faCog =
    '<img src="https://icongr.am/fontawesome/cog.svg?size=16" alt="faCog" height="10px" />';

export const faEye =
    '<img src="https://icongr.am/fontawesome/eye.svg?size=16" alt="faEye" height="10px" />';

export const faBook =
    '<img src="https://icongr.am/fontawesome/book.svg?size=16" alt="faBook" height="10px" />';
