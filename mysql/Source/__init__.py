...
class Source(BaseModel):
    ...
    url = CharField(index=True, default='')
    text = BlobField(default='')
    facebook_url = CharField(default='')
    reporting = CharField(index=True, default='')
    bias = CharField(index=True, default='')
    notes = BlobField(default='')
    raw = BlobField(default='')
    ranked = BooleanField(default=False)
    details = BlobField(default='')
    error = BooleanField(default=False)
    domains = CharField(default='')
    Links = IntegerField(index=True, default=0)
    HTTPStatusCode = IntegerField(default=0)
    MozRankURL = FloatField(default=0)
    Timelastcrawled = IntegerField(default=0)
    MozRankURLRaw = FloatField(default=0)
    ExternalEquityLinks = IntegerField(default=0)
    DomainAuthority = FloatField(default=0)
    Popularity = IntegerField(default=0)
    homepage = CharField(index=True, default='')
    review = BooleanField(default=False)
    name = CharField(index=True, default='')
    review_details = CharField(default='')
